...
class RangeTests: XCTestCase {
    ...
    func testFindIndex_1() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 1, inRanges: self.ranges)
        let expectedIndex = 0
        XCTAssert(returnedIndex == expectedIndex)
    }
    
    func testFindIndex_2() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 2, inRanges: self.ranges)
        let expectedIndex = 0
        XCTAssertEqual(returnedIndex, expectedIndex)
    }

    func testFindIndex_3() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 12, inRanges: self.ranges)
        let expectedIndex = 1
        XCTAssert(returnedIndex == expectedIndex)
    }
    
    func testFindIndex_4() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 13, inRanges: self.ranges)
        let expectedIndex = 1
        XCTAssert(returnedIndex == expectedIndex)
    }
    
    func testFindIndex_5() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 24, inRanges: self.ranges)
        let expectedIndex = 2
        XCTAssert(returnedIndex == expectedIndex)
    }
    
    func testFindIndex_6() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 25, inRanges: self.ranges)
        let expectedIndex = 2
        XCTAssert(returnedIndex == expectedIndex)
    }
    
    func testFindIndex_7() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 30, inRanges: self.ranges)
        let expectedIndex = 2
        XCTAssert(returnedIndex == expectedIndex)
    }
    
    func testFindIndex_8() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: -8, inRanges: self.ranges)
        XCTAssertNil(returnedIndex)
    }
    
    func testFindIndex_9() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 4, inRanges: self.ranges)
        let expectedIndex = 0
        XCTAssert(returnedIndex == expectedIndex)
    }
    ...
    func testFindIndex_10() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 4, inRanges: self.arrayOfTwoRanges)
        XCTAssertNil(returnedIndex)
    }
    
    func testFindIndex_11() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 39, inRanges: self.arrayOfTwoRanges)
        XCTAssertNil(returnedIndex)
    }
    
    func testFindIndex_12() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 40, inRanges: self.arrayOfTwoRanges)
        
        XCTAssertEqual(returnedIndex, 0)
    }
    
    func testFindIndex_13() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 41, inRanges: self.arrayOfTwoRanges)
        
        XCTAssertEqual(returnedIndex, 0)
    }
    
    func testFindIndex_14() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 69, inRanges: self.arrayOfTwoRanges)
        
        XCTAssertEqual(returnedIndex, 0)
    }
    
    func testFindIndex_15() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 70, inRanges: self.arrayOfTwoRanges)
        
        XCTAssertEqual(returnedIndex, 1)
    }
    
    func testFindIndex_16() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 100, inRanges: self.arrayOfTwoRanges)
    ...
    func testFindIndex_17() {
        let returnedIndex = RangeImplementation<Int>.findIndex(forLowerBound: 100, inRanges: [])
